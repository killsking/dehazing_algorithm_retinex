...
figure();imshow(msrcr);title('MSRCR')
% subplot(2,2,4);imshow(msrcr);title('MSRCR')  %显示处理后的图像
%imwrite(msrcr,'C:\Users\Administrator\Desktop\11\DIP\2-pic\retinex in matlab\结果图像\fig5_light_MSRCR.tif');%line113
%imwrite(msr,'结果图像\MSR.tif');
%imwrite(msrcr,'结果图像\MSRCR.tif');
end